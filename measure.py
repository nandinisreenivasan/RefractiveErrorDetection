    ...
    def run_config(self):
        ...
        while cap.isOpened():
            ...
            for bbox, eye in zip(bbox_list, eyes_list):
                ...
                # draw bbox
                measure.draw_bbox(image, bbox, self.colors[0])

                # draw distace between eyes
                measure.draw_dist_between_eyes(
        ...
        while cap.isOpened():
            ...
            for bbox, eye in zip(bbox_list, eyes_list):
                ...
                if distance_cm > 51:  # for safe use, distance to screen should be grater than 51 cm
                    # draw bbox
                    measure.draw_bbox(image, bbox, self.colors[2])
                    # add distance in cm
                    ...
                    # draw bbox
                    measure.draw_bbox(image, bbox, self.colors[1])
                    # add distance in cm
...
if __name__ == '__main__':
    ...
    distance_df = pd.read_csv('C:/Users/nandi/final_project/eye_to_screen_distance_measurement/distance_xy.csv')
    eye_screen_distance = measure()
